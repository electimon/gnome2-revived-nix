{ stdenv, mkDerivation, fetchurl, python2, pkg-config, gtk2, pygobject, pycairo
, python2Packages, libglade }:
...
python2Packages.buildPythonPackage rec {
  ...
  postInstall = ''
    ...
    ln -s ${pygobject}/lib/${python2.libPrefix}/site-packages/${pygobject.name}.pth \
                  $out/lib/${python2.libPrefix}/site-packages/${name}.pth
  '';

  patches = [ ./fix-pango.diff ];
  format = "other";
}
